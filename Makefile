#
# Don't edit, this file is generated by FPCMake Version 2.0.0 [2011/04/06]
#
default: all
...
override PACKAGE_VERSION=0.0.2
...
ide:$(addprefix build/bin/,${TARGET_PROGRAMS})
